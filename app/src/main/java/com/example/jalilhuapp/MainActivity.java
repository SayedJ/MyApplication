...
import static com.example.jalilhuapp.AllCategoriesDialog.ALL_CATEGORIES;
import static com.example.jalilhuapp.AllCategoriesDialog.CALLING_ACTIVITY;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.cart:
                        Intent catIntent = new Intent(MainActivity.this, CartActivity.class);
                    ...
                    case R.id.aboutUs:
                        new AlertDialog.Builder(MainActivity.this)
                                .setTitle("About us")
                                .setMessage("Developed by Jalil for AND Y Class\n  " + "check My Github for source Code")
                    ...
                    case R.id.terms:
                        new AlertDialog.Builder(MainActivity.this)
                                .setTitle("Terms and Regulation")
                                .setMessage("We have so many rules, you won't have time to check our cool app")
