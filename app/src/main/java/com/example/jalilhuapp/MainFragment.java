...
import com.example.jalilhuapp.GroceryItemAdapter;
...
public class MainFragment extends Fragment {
    ...
    private void initView(View view) {
        ...
        newItemsRecView = view.findViewById(R.id.newItemRecyView);
        popularItemsRecView = view.findViewById(R.id.popularItemRecView);
        suggestedItemsRecView = view.findViewById(R.id.suggestedItemRecView);
    }
}
