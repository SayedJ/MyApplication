...
import static com.example.jalilhuapp.GroceryItemActivity.GROCERY_ITEM_KEY;
...
public class AddReviewDialog extends DialogFragment {
    ...
    private void initViews(View view) {
        ...
        txtWarning = view.findViewById(R.id.warningTxt);
        edtTxtUserName = view.findViewById(R.id.edtTextUserName);
