...
import static com.example.jalilhuapp.R.id.cart;
import static com.example.jalilhuapp.R.id.gone;
import static com.example.jalilhuapp.R.id.secondFilledStar;
...
public class GroceryItemActivity extends AppCompatActivity implements AddReviewDialog.AddReview{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != intent) {
            ...
            if (null != incomingItem) {
                ...
                txtPrice.setText(String.valueOf(incomingItem.getPrice()) + "kr");
                Glide.with(this)
                        .asBitmap()
    ...
    private void initViews() {
        ...
        reviewsRecView = findViewById(R.id.reviewsRecycler);
